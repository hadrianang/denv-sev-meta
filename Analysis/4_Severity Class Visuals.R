...
model_names = c("LogisticRegressionModel", "FE_Model", "NoCorr")
...
model_name = model_names[[1]]
res_name = "Orig"
generate_visuals("1997type", "LogisticRegression", "Orig")
generate_visuals("2009type", "LogisticRegression", "Orig")
generate_visuals("hospitalisation", "LogisticRegression", "Orig")

#%%
generate_visuals("1997type", "NoCorr", "NoCorr")
generate_visuals("2009type", "NoCorr", "NoCorr")
generate_visuals("hospitalisation", "NoCorr", "NoCorr")